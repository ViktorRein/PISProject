...
<header>
    ...
    <form action="" method="post" class="search-form">
        ...
        if (isset($_POST['searching'])) {
            ...
            $sql = "SELECT * FROM series WHERE title LIKE :searchTerm";
      ...
      while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        echo '<p><strong>Количество сезонов:</strong> ' . $row['total_seasons'] . '</p>';
        ...
        echo '<form action="includes/series.inc.php" method="post">';
